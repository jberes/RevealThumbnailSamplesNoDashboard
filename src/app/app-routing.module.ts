...
import { TemplatedComboComponent } from './templated-combo/templated-combo.component';
...
export const routes: Routes = [
  ...
  { path: 'templated-combo', component: TemplatedComboComponent, data: { text: 'TemplatedCombo' } },
