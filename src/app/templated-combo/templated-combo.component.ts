...
@Component({
  selector: 'app-templated-combo',
  templateUrl: './templated-combo.component.html',
  styleUrls: ['./templated-combo.component.scss']
})
export class TemplatedComboComponent implements OnInit, OnDestroy {
